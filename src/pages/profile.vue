          ...
          <form class="px-3 md:px-6 pt-10">
            <div class="mb-10">
              ...
              >
                <span class="w-full self-center text-5xl font-bold">
                  <img class="w-full max-w-none rounded-full" alt="userData.name" src="~/static/img/blank.jpeg" />
                </span>
              </div>
            </div>
            <div
            ...
            >
              <div class="flex flex-col">
                ...
                <div class="flex flex-col mb-3">
                  <label class="font-medium mb-2 pl-1">Email</label>
                  <input
                    type="text"
                    disabled
                    class="rounded-md border border-gray-300 bg-gray-300 font-roboto py-2 px-3"
              ...
              <div class="flex justify-end mt-4">
                <nuxt-link to="/logout" class="ml-2 rounded-full py-2 px-6 border border-solid border-secondary bg-secondary hover:bg-yellow-700 text-white focus:outline-none inline-block">
          ...
          <ul class="flex justify-between px-10">
            <li class="cursor-pointer hover:text-secondary text-gray-400">
              <nuxt-link to="/dashboard">
                <svg class="fill-current" width="24" height="21" viewBox="0 0 24 21">
